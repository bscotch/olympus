function demo_olympus_test_async_with_custom_global_callback_name(){	
	olympus_run("My_Suite_Name", function(){
		...
		var new_handler_function = function(argument){
		    ...
		    if (http_status == 200){
		        show_debug_message("Pinging Microsoft succeeded.");
		    }
		    else{
		...
		olympus_add_async_test("Test pinging Microsoft", mediator_spawning_logic, new_handler_function);	
	},
